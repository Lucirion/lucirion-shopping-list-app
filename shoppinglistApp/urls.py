...
urlpatterns = [
    ...
    path(
        'login/jp/',
        views.CustomLoginJPView.as_view(),
        name='login_jp'
    ),
    path(
        'logout/',
    ...
    path(
        'list/jp/',
        views.shopping_list_jp,
        name='shopping_list_jp'
    ),
    path(
        'toggle/<int:item_id>/',
    ...
    path(
        'jp/toggle/<int:item_id>/',
        views.toggle_completed_jp,
        name='toggle_completed_jp'
    ),
    path(
        'edit/<int:item_id>',
        views.edit_item,
    ...
    path(
        'jp/remove/<int:item_id>',
        views.delete_item_jp,
        name='delete_item_jp'
    ),
